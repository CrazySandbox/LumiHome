...
var Slider = React.createClass({
  ...
  render() {
    ...
    var thumbLeft;
    if(value.__getValue() == minimumValue)
    {
      thumbLeft = 0;
    }else if(value.__getValue() == maximumValue)
    {
      thumbLeft = containerSize.width - thumbSize.width;
    }else {
  ...
  _renderThumbImage() {
    ...
    return <Image  source={thumbImage} style={this.props.styleThumbImage} />;
  }
});
